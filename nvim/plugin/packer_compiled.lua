...
_G.packer_plugins = {
  ...
  base46 = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/mounirbennacer/.local/share/nvim/site/pack/packer/opt/base46",
  ...
  ["better-escape.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/mounirbennacer/.local/share/nvim/site/pack/packer/opt/better-escape.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/Users/mounirbennacer/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nvim-gps"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/mounirbennacer/.local/share/nvim/site/pack/packer/opt/nvim-gps",
  ...
  ["shade.nvim"] = {
    loaded = true,
    path = "/Users/mounirbennacer/.local/share/nvim/site/pack/packer/start/shade.nvim",
  ...
  ["vim-ultest"] = {
    ...
    config = { "\27LJ\2\n3\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\24custom.plugins.test\frequire\0" },
    keys = { { "", "<leader>t" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/mounirbennacer/.local/share/nvim/site/pack/packer/opt/vim-ultest",
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-surround', 'friendly-snippets', 'copilot.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
